...
import { translator } from './start-translator.js';

describe('w:start border translator', () => {
  describe('encode', () => {
    it('encodes a complex <w:start> border element correctly', () => {
  ...
  describe('decode', () => {
    it('decodes a complex start border object correctly', () => {
