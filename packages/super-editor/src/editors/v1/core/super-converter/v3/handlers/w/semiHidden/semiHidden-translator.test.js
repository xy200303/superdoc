...
import { translator } from './semiHidden-translator.js';
import { NodeTranslator } from '../../../node-translator/node-translator.js';

describe('w:semiHidden translator (attribute)', () => {
  it('exposes correct translator meta', () => {
    expect(translator.xmlName).toBe('w:semiHidden');
    expect(translator.sdNodeOrKeyName).toBe('semiHidden');
