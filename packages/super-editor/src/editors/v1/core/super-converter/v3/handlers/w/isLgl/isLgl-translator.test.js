...
import { translator } from './isLgl-translator.js';
import { NodeTranslator } from '../../../node-translator/node-translator.js';

describe('w:isLgl translator (attribute)', () => {
  it('exposes correct translator meta', () => {
    expect(translator.xmlName).toBe('w:isLgl');
    expect(translator.sdNodeOrKeyName).toBe('isLgl');
