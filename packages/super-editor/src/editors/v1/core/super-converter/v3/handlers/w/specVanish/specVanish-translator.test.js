...
import { translator } from './specVanish-translator.js';
import { NodeTranslator } from '../../../node-translator/node-translator.js';

describe('w:specVanish translator (attribute)', () => {
  it('exposes correct translator meta', () => {
    expect(translator.xmlName).toBe('w:specVanish');
    expect(translator.sdNodeOrKeyName).toBe('specVanish');
