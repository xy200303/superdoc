...
import { translator } from './qFormat-translator.js';
import { NodeTranslator } from '../../../node-translator/node-translator.js';

describe('w:qFormat translator (attribute)', () => {
  it('exposes correct translator meta', () => {
    expect(translator.xmlName).toBe('w:qFormat');
    expect(translator.sdNodeOrKeyName).toBe('qFormat');
