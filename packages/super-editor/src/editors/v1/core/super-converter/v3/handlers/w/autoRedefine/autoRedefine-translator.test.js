...
import { translator } from './autoRedefine-translator.js';
import { NodeTranslator } from '../../../node-translator/node-translator.js';

describe('w:autoRedefine translator (attribute)', () => {
  it('exposes correct translator meta', () => {
    expect(translator.xmlName).toBe('w:autoRedefine');
    expect(translator.sdNodeOrKeyName).toBe('autoRedefine');
