...
import { translator } from './bdr-translator.js';

describe('w:bdr border translator', () => {
  describe('encode', () => {
    it('encodes a complex <w:bdr> border element correctly', () => {
  ...
  describe('decode', () => {
    it('decodes a complex bdr border object correctly', () => {
