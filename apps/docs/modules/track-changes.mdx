...
<Tip>
Building your own review panel in React? Skip the built-in UI and read [Bring Your Own UI › Track changes](/bring-your-own-ui/track-changes) instead. It documents `useSuperDocTrackChanges` plus accept / reject / next / previous and the typed surface for accept-all / reject-all flows.
</Tip>
